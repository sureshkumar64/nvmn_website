...
import bannerImage1 from '../../assets/images/banner_1.png';
import bannerImage2 from '../../assets/images/banner_2.png';
        ...
        <Grid container spacing={4}>
            ...
            <div className='banner__inner banner__inner--left'>
              ...
              <div className='banner__content'>
                <div className='content__wrapper'>
                  <div className='content__subtitle'>NVMN Store</div>
          ...
          <Grid item xs={12} sm={6}>
            <div className='banner__inner banner__inner--right'>
              ...
              <div className='banner__content'>
                <div className='content__wrapper'>
                  <span className='content__subtitle'>NVMN Store</span>
                  <h2 className='content__title'>
                    Famous &amp;
                    <br /> Local Brands
                  </h2>
